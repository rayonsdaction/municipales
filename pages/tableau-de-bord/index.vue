<template>
  <div class="max-w-4xl mx-auto mt-14 px-4 sm:px-6 lg:px-8 lg:mt-24">
    <h1 class="text-center text-3xl text-ra-green-600 font-bold mb-8">
      Tableau de bord de suivi du {{ config.projectName }}
    </h1>
    <div v-if="!geojsons">
      Chargement ...
    </div>
...
const description = `Tableau de bord de suivi du ${config.projectName} en temps réel.`;
useHead({
  title: `Tableau de bord de suivi du ${config.projectName}`,
  meta: [
