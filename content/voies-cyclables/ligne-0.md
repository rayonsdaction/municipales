...
La rive Est dispose d’une piste cyclable bidirectionnelle, mais celle-ci est trop étroite pour absorber le flux dense aux heures de pointe. Plusieurs problèmes s’ajoutent à cette contrainte :
* les jonctions avec les pistes unidirectionnelles vers le boulevard de la Liberté et la Tour d'Auvergne imposent des angles de giration trop serrés, et une cohabitation compliquée avec les piétons
* la jonction vers la piste unidirectionnelle du boulevard de la Tour d'Auvergne se fait en deux phases de feu alors qu'en voiture un seul cycle suffit
* la jonction vers le quai Duguay Trouin se fait de manière abrute dans le sens sud -> nord
* il n'y a pas d'espace de stockage aux feux pour les cyclistes qui tournent
* au contraire, les feux réduisent la largeur de la bande là où certains attendent pour tourner
* La piste cyclable est presque invisible pour rejoindre le boulevard de Chézy ce qui complique la cohabitation avec les piétons

Une bande cyclable existe en rive Ouest dans le sens nord -> sud. Moins sécurisée, peu visible et souvent utilisée pour du stationnement minute, elle permet cependant de rejoindre la Tour d'Auvergne de manière plus directe et rapide en venant du quai de la Prévalaye.

![](/images/ligne-0/REV-Rennes-ligne-0-place-de-bretagne.jpg)
